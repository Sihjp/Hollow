...
<body>
    ...
    <!-- Contact 3 - Bootstrap Brain Component -->
        ...
        <div class="container bg-white border rounded shadow">
                ...
                <div class="col-12 col-xl-11">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div>
                            ...
                            <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="tel:+15057922430">+62 123-1234-1234</a>
                            </p>
                        </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        ...
                        <div>
                            ...
                            <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="mailto:Ardhiansyah203@gmail.com">Ardhiansyah203@gmail.com</a>
                            </p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <h4 class="mb-3">Available Hours</h4>
            ...
            <div class="col-12 col-lg-6">
                <div class="bg-white border rounded shadow-sm overflow-hidden text-dark">
                <form action="contact/proses_kontak.php" method="POST">
